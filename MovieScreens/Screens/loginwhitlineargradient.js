...
export const Hhh = ({ navigation }) => {
    return (
        <View style={{ height: height, width: width, }}>
            <SafeAreaView>
                <View style={{ height: '100%', }}>
                    <StatusBar style="light" />
                    <ImageBackground source={require('../assets/jocker.jpg')}
                        style={{
                            flex: 1,
                    ...
                    <LinearGradient colors={['rgba(0,0,0,0.7)', '#26282C', '#26282C']}>
                        ...
                        <View style={{ paddingHorizontal: 20, width: '100%', height: '100%', display: 'flex', flexDirection: 'column', }}>
                            ...
                            <View style={{ width: '100%', height: 'auto', gap: 20, }}>
                                ...
                                <Pressable style={{ backgroundColor: '#FDD130', width: '100%', paddingVertical: 10, alignItems: 'center', borderRadius: 5, justifyContent: 'center', }} onPress={() => navigation.navigate('Welcome')}>
